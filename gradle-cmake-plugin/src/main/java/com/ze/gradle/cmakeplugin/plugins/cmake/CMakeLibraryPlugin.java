...
import com.ze.gradle.cmakeplugin.tasks.CMake;
import com.ze.gradle.cmakeplugin.tasks.CMakeBuild;
...
public class CMakeLibraryPlugin implements Plugin<Project> {
    public void apply(final Project project) {
        project.getPluginManager().apply("com.ze.gradle.cmakeplugin.wrapped-native-library");
        ...
        final TaskProvider<CMake> cmakeDebug = tasks.register("cmakeDebug", CMake.class, task -> {
            ...
            task.getCmakeDirectory().set(extension.getCmakeDirectory());
